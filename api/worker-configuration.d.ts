/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 922c33942beb6e91a4f3bde2a43b0860)
// Runtime types generated with workerd@1.20250917.0 2025-09-17 enable_request_signal,nodejs_compat,request_signal_passthrough
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'PqcContainerSidecar';
	}
	interface Env {
		ENVIRONMENT: 'preview';
		NODE_ENV: 'development';
		PQC_CONTAINER_SIDECAR: DurableObjectNamespace<import('./src/index').PqcContainerSidecar>;
