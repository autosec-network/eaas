/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f8d48aa4b4b5e7df2392ae8a5f78d1cd)
// Runtime types generated with workerd@1.20260301.1 2026-02-24 no_nodejs_compat_v2,nodejs_compat,queue_consumer_no_wait_for_wait_until
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
	}
	interface Env {
		CATALOG_ROW: R2Bucket;
		CATALOG_EU: R2Bucket;
	}
}
