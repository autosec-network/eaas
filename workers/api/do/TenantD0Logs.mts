...
export class TenantD0Logs extends BaseD0 {
	protected override drizzle: DrizzleSqliteDODatabase<typeof tenantLogsSchema>;
	...
	protected override _migrate() {
		return Promise.all([import('drizzle-orm/durable-sqlite/migrator'), import('db/schemas/tenant/logs/migrations')]).then(async ([{ migrate }, { default: migrations }]) =>
			migrate(
