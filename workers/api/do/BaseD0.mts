...
import type * as tenantSchema from 'db/schemas/tenant';
import type * as userSchema from 'db/schemas/user';
...
export abstract class BaseD0 extends DurableObject<EnvVars> {
	...
	protected drizzle: DrizzleSqliteDODatabase<typeof tenantSchema | typeof userSchema>;
