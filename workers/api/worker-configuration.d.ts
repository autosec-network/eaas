/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8aee8228725e5810776623cf6e18039d)
// Runtime types generated with workerd@1.20260430.1 2026-04-05 enable_request_signal,nodejs_compat,request_signal_passthrough
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'BitwardenSession' | 'TenantD0' | 'TenantD0Logs' | 'UserD0' | 'NoisePipe';
	}
	interface ProdEnv {
		DB_ROOT: D1Database;
		...
		NOISE_PIPE: DurableObjectNamespace<import('./src/index').NoisePipe>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'NOISE_PIPE_TTL' | 'SQL_TTL' | 'WS_AUTH_TTL' | 'CF_API_TOKEN' | 'EU_BW_SM_ACCESS_TOKEN' | 'US_BW_SM_ACCESS_TOKEN'>> {}
}
