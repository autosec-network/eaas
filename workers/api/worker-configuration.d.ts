/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 81e050aedf117a9b6c40528720079689)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 enable_request_signal,new_module_registry,nodejs_compat,queue_consumer_no_wait_for_wait_until,request_signal_passthrough
interface __BaseEnv_Env {
	...
	BITWARDEN_SESSION: DurableObjectNamespace<import('./src/index').BitwardenSession>;
	TENANT_D0: DurableObjectNamespace<import('./src/index').TenantD0>;
	TENANT_D0_LOGS: DurableObjectNamespace<import('./src/index').TenantD0Logs>;
	USER_D0: DurableObjectNamespace<import('./src/index').UserD0>;
	...
	DATA_KEY_ROTATION: Workflow<Parameters<import('./src/index').DataKeyRotation['run']>[0]['payload']>;
	VAULT_MIGRATION: Workflow<Parameters<import('./src/index').VaultMigration['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'BitwardenSession' | 'TenantD0' | 'TenantD0Logs' | 'UserD0';
	}
	interface ProdEnv {
		DB_ROOT: D1Database;
		PLATFORM_ANALYTICS: AnalyticsEngineDataset;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SQL_TTL' | 'WS_AUTH_TTL' | 'CF_API_TOKEN' | 'EU_BW_SM_ACCESS_TOKEN' | 'US_BW_SM_ACCESS_TOKEN'>> {}
}
