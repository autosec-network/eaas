/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3dcbdd1e923a854e82304c64ffba2264)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SQL_TTL' | 'ZT_TEAM_DOMAIN' | 'ZT_APP_AUD' | 'AUTH_SECRET_DEV' | 'AUTH_SECRET_PROD' | 'CF_API_TOKEN'>> {}
}
