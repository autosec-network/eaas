/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7fd423e07e76b5031914330736586af6)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 enable_request_signal,global_fetch_strictly_public,new_module_registry,nodejs_compat,queue_consumer_no_wait_for_wait_until,request_signal_passthrough
interface __BaseEnv_Env {
	DB_ROOT_PREVIEW: D1Database;
	DB_ROOT_PROD: D1Database;
	ADMIN_MANAGEMENT: Queue;
	LOGS_DEV: Queue;
	LOGS_PROD: Queue;
	ASSET: Fetcher;
	...
	AUTH_SECRET_DEV: string;
	AUTH_SECRET_PROD: string;
	CF_API_TOKEN: string;
	EU_BW_SM_ACCESS_TOKEN: string;
	US_BW_SM_ACCESS_TOKEN: string;
	BITWARDEN_SESSION_PROD: DurableObjectNamespace /* BitwardenSession from eaas-api-prod */;
	TENANT_D0_PROD: DurableObjectNamespace /* TenantD0 from eaas-api-prod */;
	TENANT_D0_LOGS_PROD: DurableObjectNamespace /* TenantD0Logs from eaas-api-prod */;
	USER_D0_PROD: DurableObjectNamespace /* UserD0 from eaas-api-prod */;
	USER_SESSION_PROD: DurableObjectNamespace /* UserSession from eaas-customer-prod */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SQL_TTL' | 'ZT_TEAM_DOMAIN' | 'ZT_APP_AUD' | 'AUTH_SECRET_DEV' | 'AUTH_SECRET_PROD' | 'CF_API_TOKEN' | 'EU_BW_SM_ACCESS_TOKEN' | 'US_BW_SM_ACCESS_TOKEN'>> {}
}
