...
import { USER_TABS } from '~/routes/[environment]/users/db-helpers';
...
export const UserTabs = component$(() => {
	...
	const base = `/${loc.params['environment']}/users/${loc.params['uid']}`;

	return (
		<nav class="border-default-medium flex flex-wrap gap-1 border-b dark:border-gray-700" aria-label="User sections">
			{USER_TABS.map((tab) => {
