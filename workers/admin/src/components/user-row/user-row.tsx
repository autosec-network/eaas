		...
		<tr class="border-default-medium hover:bg-surface-light border-b dark:border-gray-700 dark:hover:bg-gray-600">
			...
			<td class="px-4 py-3">
				<div class="flex items-center gap-1.5">
					{doIdHex ? (
						<a target="_blank" rel="noreferrer" href={`https://dash.cloudflare.com/${cfAccountId.value}/workers/durable-objects/view/${StaticDatabase.User.Main['eaas-api-prod_UserD0']}/studio?objectId=${doIdHex}`} class="text-primary-accent inline-flex flex-wrap items-center gap-1.5 rounded-sm text-sm hover:underline focus:ring-2 focus:ring-blue-500 focus:outline-none">
