		...
		<div class="flex min-h-[60vh] items-center justify-center px-4">
			<div class="w-full max-w-sm">
				<div class="border-surface-light/60 shadow-primary-accent/5 dark:border-surface-dark/60 dark:bg-surface-dark/70 rounded-2xl border bg-white/70 p-8 shadow-xl backdrop-blur-md">
					...
					<h1 class="mb-3 text-center text-xl font-semibold text-gray-900 dark:text-white">Check your email</h1>
					<p class="mb-2 text-center text-sm leading-relaxed text-gray-500 dark:text-gray-400">A sign-in link has been sent to your email address.</p>
					<p class="mb-6 text-center text-xs text-gray-400 dark:text-gray-500">You can close this window or return to the login page.</p>
