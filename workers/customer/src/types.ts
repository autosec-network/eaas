...
export interface EnvVars extends Omit<Cloudflare.Env, 'BITWARDEN_SESSION' | 'TENANT_D0' | 'USER_D0'>, TypedBindings {
	GIT_HASH?: string;
...
declare class BitwardenSession extends DurableObject {
	public init(_options: { endpoints: { base: string; authentication: string } }): Promise<void>;
