/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 24a80fb4d1e6897109c67219cff92135)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SQL_TTL' | 'TURNSTILE_SITE_KEY' | 'AUTH_SECRET' | 'BREVO_EMAIL_API_KEY' | 'TURNSTILE_SECRET_KEY'>> {}
}
