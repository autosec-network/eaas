/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0243f00bf144943fa20871da40515c5)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 enable_request_signal,global_fetch_strictly_public,new_module_registry,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	DB_ROOT: D1Database;
	EMAIL: SendEmail;
	LANG_ANALYTICS?: AnalyticsEngineDataset;
	LOGS: Queue;
	VAULT_RESCAN_RATE_LIMITER: RateLimit;
	ASSET: Fetcher;
	...
	USER_SESSION: DurableObjectNamespace<import('./src/entry.cloudflare-workers').UserSession>;
	BITWARDEN_SESSION: DurableObjectNamespace /* BitwardenSession from eaas-api-prod */ | DurableObjectNamespace /* BitwardenSession from eaas-api-dev */;
	TENANT_D0: DurableObjectNamespace /* TenantD0 from eaas-api-prod */ | DurableObjectNamespace /* TenantD0 from eaas-api-dev */;
	TENANT_D0_LOGS: DurableObjectNamespace /* TenantD0Logs from eaas-api-prod */ | DurableObjectNamespace /* TenantD0Logs from eaas-api-dev */;
	USER_D0: DurableObjectNamespace /* UserD0 from eaas-api-prod */ | DurableObjectNamespace /* UserD0 from eaas-api-dev */;
	BITWARDEN_SESSION_PROXY?: Service /* entrypoint BitwardenSessionProxy from eaas-do-proxy */;
	TENANT_D0_PROXY?: Service /* entrypoint TenantD0Proxy from eaas-do-proxy */;
	TENANT_D0_LOGS_PROXY?: Service /* entrypoint TenantD0LogsProxy from eaas-do-proxy */;
	USER_D0_PROXY?: Service /* entrypoint UserD0Proxy from eaas-do-proxy */;
	USER_SESSION_PROXY?: Service /* entrypoint UserSessionProxy from eaas-do-proxy */;
	DATA_KEY_ROTATION: Workflow /* DataKeyRotation from eaas-api-prod */ | Workflow /* DataKeyRotation from eaas-api-dev */;
	VAULT_MIGRATION: Workflow /* VaultMigration from eaas-api-prod */ | Workflow /* VaultMigration from eaas-api-dev */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/entry.cloudflare-workers');
	...
	interface ProdEnv {
		...
		TURNSTILE_SECRET_KEY: string;
		USER_SESSION: DurableObjectNamespace<import('./src/entry.cloudflare-workers').UserSession>;
		BITWARDEN_SESSION: DurableObjectNamespace /* BitwardenSession from eaas-api-prod */;
		TENANT_D0: DurableObjectNamespace /* TenantD0 from eaas-api-prod */;
		TENANT_D0_LOGS: DurableObjectNamespace /* TenantD0Logs from eaas-api-prod */;
		USER_D0: DurableObjectNamespace /* UserD0 from eaas-api-prod */;
		BITWARDEN_SESSION_PROXY: Service /* entrypoint BitwardenSessionProxy from eaas-do-proxy */;
		TENANT_D0_PROXY: Service /* entrypoint TenantD0Proxy from eaas-do-proxy */;
		TENANT_D0_LOGS_PROXY: Service /* entrypoint TenantD0LogsProxy from eaas-do-proxy */;
		USER_D0_PROXY: Service /* entrypoint UserD0Proxy from eaas-do-proxy */;
		USER_SESSION_PROXY: Service /* entrypoint UserSessionProxy from eaas-do-proxy */;
		DATA_KEY_ROTATION: Workflow /* DataKeyRotation from eaas-api-prod */;
		VAULT_MIGRATION: Workflow /* VaultMigration from eaas-api-prod */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SESSION_TTL' | 'SQL_TTL' | 'TURNSTILE_SITE_KEY' | 'AUTH_SECRET' | 'EU_BW_SM_ACCESS_TOKEN' | 'US_BW_SM_ACCESS_TOKEN' | 'TURNSTILE_SECRET_KEY'>> {}
}
