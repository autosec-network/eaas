/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93825b08b775597b5fefd13e1482eb79)
// Runtime types generated with workerd@1.20260312.1 2026-03-12 enable_request_signal,global_fetch_strictly_public,nodejs_compat,request_signal_passthrough
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SESSION_TTL' | 'SQL_TTL' | 'TURNSTILE_SITE_KEY' | 'AUTH_SECRET' | 'BREVO_EMAIL_API_KEY' | 'EU_BW_SM_ACCESS_TOKEN' | 'US_BW_SM_ACCESS_TOKEN' | 'TURNSTILE_SECRET_KEY'>> {}
}
