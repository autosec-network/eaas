/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a1ff439f0e1868d1546664c3947da490)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SQL_TTL' | 'TURNSTILE_SITE_KEY' | 'AUTH_SECRET' | 'TURNSTILE_SECRET_KEY' | 'BREVO_EMAIL_API_KEY'>> {}
}
