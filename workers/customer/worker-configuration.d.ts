/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 60f0c6c7bb0963ab31c06810a0cdc371)
// Runtime types generated with workerd@1.20260301.1 2026-02-24 enable_request_signal,global_fetch_strictly_public,nodejs_compat,request_signal_passthrough
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV' | 'SESSION_TTL' | 'SQL_TTL' | 'TURNSTILE_SITE_KEY' | 'AUTH_SECRET' | 'BREVO_EMAIL_API_KEY' | 'TURNSTILE_SECRET_KEY'>> {}
}
