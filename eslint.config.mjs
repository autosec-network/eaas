...
export default defineConfig({
	...
	extends: [eslint.configs.recommended, tseslint.configs.recommendedTypeChecked, tseslint.configs.stylisticTypeChecked, eslintConfigPrettier, eslintPluginZod.configs.recommended, eslintPluginZodMini.configs.recommended],
	plugins: {
