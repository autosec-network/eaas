...
export const users = sqliteTable('users', (u) => ({
	...
	jurisdiction: u.text({ enum: [DOJurisdictions['The European Union'], DOJurisdictions['FedRAMP-compliant data centers'], DOJurisdictions['FedRAMP High authorization']] }).$type<DOJurisdictions>(),
...
export const tenants = sqliteTable('tenants', (t) => ({
	...
	jurisdiction: t.text({ enum: [DOJurisdictions['The European Union'], DOJurisdictions['FedRAMP-compliant data centers'], DOJurisdictions['FedRAMP High authorization']] }).$type<DOJurisdictions>(),
